...
title: Alex Singh site in depth
excerpt: While easy to get started, the Alex Singh site is quite complex internally. This page provides documentation on some of the more intricate parts.
